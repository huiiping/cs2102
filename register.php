		...
		<form action="register.php" method="post">
			<table align="center"> 
			  <tr>
				...
				<td><input type="text" name="name" class="register_input" required /></td>
			  </tr>
			  <tr>
				<td><label class="register_label">Email Address: </label></td>
				<td><input type="email" name="email" class="register_input" required /></td>
			  </tr>
			  <tr>
				<td><label class="register_label">Residential Address: </label></td>
				<td><textarea name="address" class="register_input2" required></textarea></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<td><input type="radio" name="logon" value="ADMIN" required/>Admin
					<input type="radio" name="logon" value="USERPUBLIC" required />User Public</td>
			  </tr>
			  <tr>
				<td></td>
...
<?php
include('php_func\registration.php');
?>
