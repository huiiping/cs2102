...
<li class="divider"></li>
    ...
    <div class="center_content">
		<ul class="nav nav-pills">
			...
			<li class="active"><a href="mybiditems.php">Bid Items</a></li>
			
		</ul>
		<br>
<div class="center_title_bar">Current Bidding Items</div>
		<?php
		include 'php_func\functions.php';
		$result = select_Current_Bidding_Items();
...
<div class="center_title_bar">History of Bidding Items</div>
		<?php
		include 'php_func\functions.php';
		$result = select_History_Of_Bidding_Items();
